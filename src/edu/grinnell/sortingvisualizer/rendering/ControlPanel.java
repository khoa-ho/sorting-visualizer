...
public class ControlPanel extends JPanel {
     ...
     */
    private static List<SortEvent<Integer>> generateEvents(String sort, ArrayList<Integer> l) {
        switch (sort) {
        case "Selection":
    ...
    /**
     * @param fps
     *            the frames-per-second the simulation should run in
     ...
     * @param panel
     *            the ArrayPanel that this panel renders to
     */
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        JComboBox<String> sorts = new JComboBox<>(
